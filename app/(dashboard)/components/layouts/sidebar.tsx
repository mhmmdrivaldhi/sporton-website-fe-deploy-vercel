...
const Sidebar = () => {
    ...
    return (
        <aside className="w-80 min-h-screen bg-white border-r border-gray-100 flex flex-col fixed top-0 left-0">
            ...
            <button className="flex gap-3 py-2 px-4.5 font-medium mx-5 hover:bg-red-500 hover:text-gray-100 duration-200 rounded-lg mt-auto mb-10" onClick={handleLogout}><FiLogOut size={24} />Log Out</button>
        </aside>
    )
}
