    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Product">
      <div className="flex flex-col gap-6">
        ...
        <div className="input-group-admin">
            ...
            <textarea name="description" id="description" rows={5} placeholder='Product Details...'></textarea>
        </div>
        <Button className='ml-auto rounded-lg' size='small'>Crate Product</Button>
      </div>
    </Modal>
  );
};
