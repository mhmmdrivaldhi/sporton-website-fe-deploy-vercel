        ...
        <CardWithHeader title="Order Information">
            <div className="p-5">
                <div className="input-group">
                    ...
                    <input type="text" placeholder="Type your full name" name="customerName" id="customerName" onChange={handleInputChange} value={formData.customerName}/>
                </div>
                <div className="input-group">
                ...
                <div className="input-group">
                    ...
                    <textarea placeholder="Example Street, 18, West Jakarta, Indonesia, 66521" name="customerAddress" id="customerAddress" onChange={handleInputChange} value={formData.customerAddress} rows={7}></textarea>
                </div>
            </div>
        </CardWithHeader>
    )
